...
//#define LOG_NDEBUG 0
#define LOG_TAG "samsung_gti9100_OMXCodec"
...
#include "device/samsung_gti9100_TICameraParameters.h"
...
struct OMXCodecObserver : public BnOMXObserver {
    ...
    void setCodec(const sp<Samsung_GTi9100_OMXCodec> &target) {
        mTarget = target;
    }

    // from IOMXObserver
    virtual void onMessage(const omx_message &msg) {
        sp<Samsung_GTi9100_OMXCodec> codec = mTarget.promote();
...
private:
    wp<Samsung_GTi9100_OMXCodec> mTarget;
...
// static
#if defined(OMAP_ENHANCEMENT) || defined(OMAP_COMPAT)
uint32_t Samsung_GTi9100_OMXCodec::getComponentQuirks(const char *componentName,bool isEncoder, uint32_t flags) {
#else
uint32_t Samsung_GTi9100_OMXCodec::getComponentQuirks(const char *componentName, bool isEncoder) {
#endif
    uint32_t quirks = 0;
    ...
    if (!strcmp(componentName, "OMX.TI.Video.Decoder") ||
        ...
        if( flags & kPreferThumbnailMode) {
                quirks |= Samsung_GTi9100_OMXCodec::kRequiresAllocateBufferOnOutputPorts;
        }
    }
#ifdef TARGET_OMAP4
        ...
        if(flags & kPreferThumbnailMode)
        {
            quirks |= Samsung_GTi9100_OMXCodec::kThumbnailMode;
        }

        if(flags & kPreferInterlacedOutputContent) {
                quirks |= Samsung_GTi9100_OMXCodec::kInterlacedOutputContent;
        }
...
// static
void Samsung_GTi9100_OMXCodec::findMatchingCodecs(
        const char *mime,
...
// static
sp<MediaSource> Samsung_GTi9100_OMXCodec::Create(
        const sp<ISamsung_GTi9100_OMX> &omx,
    ...
    ISamsung_GTi9100_OMX::node_id node = 0;
...
//roger
        ...
        if (err == OK) {
            ...
            sp<Samsung_GTi9100_OMXCodec> codec = new Samsung_GTi9100_OMXCodec(
                    omx, node, quirks,
...
sp<MediaSource> Samsung_GTi9100_OMXCodec::Create(
        ...
        const sp<MetaData> &meta, bool createEncoder,
        const sp<MediaSource> &source,
        ISamsung_GTi9100_OMX::node_id &nodeId,
        const char *matchComponentName,
        uint32_t flags) {
    const char *mime;
    bool success = meta->findCString(kKeyMIMEType, &mime);
...
status_t Samsung_GTi9100_OMXCodec::configureCodec(const sp<MetaData> &meta, uint32_t flags) {
#if !(defined(OMAP_ENHANCEMENT) && defined (TARGET_OMAP4))
    ...
    if (!strcasecmp(MEDIA_MIMETYPE_AUDIO_AAC, mMIME)) {
        ...
        if (!strcmp(mComponentName, "OMX.TI.AAC.decode")) {
            ...
            CODEC_LOGV("Samsung_GTi9100_OMXCodec::configureCodec() TI AAC - Configure Component to FrameMode");
            ...
            if (err != OK) {
                CODEC_LOGV("Samsung_GTi9100_OMXCodec::configureCodec() TI AAC - Problem getting ExtensionIndex - Use SteamMode");
            }
            else {
                OMX_U16 framemode = 1;
                ...
                if (err != OK) {
                    CODEC_LOGV("Samsung_GTi9100_OMXCodec::configureCodec() TI AAC - Problem configuring FrameMode - Use SteamMode");
                }
            }
        }
#endif
...
void Samsung_GTi9100_OMXCodec::setMinBufferSize(OMX_U32 portIndex, OMX_U32 size) {
...
status_t Samsung_GTi9100_OMXCodec::setVideoPortFormatType(
        OMX_U32 portIndex,
...
status_t Samsung_GTi9100_OMXCodec::findTargetColorFormat(
...
status_t Samsung_GTi9100_OMXCodec::isColorFormatSupported(
...
void Samsung_GTi9100_OMXCodec::setVideoInputFormat(
...
status_t Samsung_GTi9100_OMXCodec::setupErrorCorrectionParameters() {
...
status_t Samsung_GTi9100_OMXCodec::setupBitRate(int32_t bitRate) {
...
#if defined (TARGET_OMAP4) && defined (OMAP_ENHANCEMENT)
status_t Samsung_GTi9100_OMXCodec::setupEncoderPresetParams(int32_t isS3DEnabled) {
...
status_t Samsung_GTi9100_OMXCodec::setupEncoderFrameDataContentParams(const sp<MetaData>& meta) {
...
status_t Samsung_GTi9100_OMXCodec::getVideoProfileLevel(
        const sp<MetaData>& meta,
        const Samsung_GTi9100_CodecProfileLevel& defaultProfileLevel,
        Samsung_GTi9100_CodecProfileLevel &profileLevel) {
...
status_t Samsung_GTi9100_OMXCodec::setupH263EncoderParameters(const sp<MetaData>& meta) {
    ...
    Samsung_GTi9100_CodecProfileLevel defaultProfileLevel, profileLevel;
...
status_t Samsung_GTi9100_OMXCodec::setupMPEG4EncoderParameters(const sp<MetaData>& meta) {
    int32_t iFramesInterval, frameRate, bitRate;
    bool success = meta->findInt32(kKeyBitRate, &bitRate);
    success = success && meta->findInt32(kKeySampleRate, &frameRate);
    success = success && meta->findInt32(kKeyIFramesInterval, &iFramesInterval);
...
status_t Samsung_GTi9100_OMXCodec::setupAVCEncoderParameters(const sp<MetaData>& meta) {
    int32_t iFramesInterval, frameRate, bitRate;
...
status_t Samsung_GTi9100_OMXCodec::setVideoOutputFormat(
    ...
    if(!strcmp(mComponentName, "OMX.TI.DUCATI1.VIDEO.DECODER")) {
         ...
         if(mQuirks & Samsung_GTi9100_OMXCodec::kThumbnailMode){
...
Samsung_GTi9100_OMXCodec::Samsung_GTi9100_OMXCodec(
        const sp<ISamsung_GTi9100_OMX> &omx, ISamsung_GTi9100_OMX::node_id node, uint32_t quirks,
        bool isEncoder,
        const char *mime,
        const char *componentName,
        const sp<MediaSource> &source)
...
// static
void Samsung_GTi9100_OMXCodec::setComponentRole(
        const sp<ISamsung_GTi9100_OMX> &omx, ISamsung_GTi9100_OMX::node_id node, bool isEncoder,
        const char *mime) {
    struct MimeToRole {
        const char *mime;
...
status_t Samsung_GTi9100_OMXCodec::init() {
    // mLock is held.
...
// static
bool Samsung_GTi9100_OMXCodec::isIntermediateState(State state) {
...
status_t Samsung_GTi9100_OMXCodec::allocateBuffers() {
...
status_t Samsung_GTi9100_OMXCodec::allocateBuffersOnPort(OMX_U32 portIndex) {
    OMX_PARAM_PORTDEFINITIONTYPE def;
    InitOMXParams(&def);
    def.nPortIndex = portIndex;
...
LOGE("1");
    size_t totalSize = def.nBufferCountActual * ((def.nBufferSize + 31) & (~31));
            ...
            if( !strcmp(mComponentName, "OMX.TI.DUCATI1.VIDEO.DECODER") &&
                (mQuirks & Samsung_GTi9100_OMXCodec::kThumbnailMode) &&
...
LOGE("3");
        mDealer[portIndex] = new MemoryDealer(totalSize, "Samsung_GTi9100_OMXCodec");
    }
...
LOGE("8");
        ...
        ISamsung_GTi9100_OMX::buffer_id buffer;
        if (portIndex == kPortIndexInput
...
void Samsung_GTi9100_OMXCodec::on_message(const omx_message &msg) {
    switch (msg.type) {
        ...
        {
            ISamsung_GTi9100_OMX::buffer_id buffer = msg.u.extended_buffer_data.buffer;
...
void Samsung_GTi9100_OMXCodec::registerBuffers(const sp<IMemoryHeap> &mem) {
    mPmemInfo = mem;
}
void Samsung_GTi9100_OMXCodec::onEvent(OMX_EVENTTYPE event, OMX_U32 data1, OMX_U32 data2) {
    switch (event) {
...
void Samsung_GTi9100_OMXCodec::onCmdComplete(OMX_COMMANDTYPE cmd, OMX_U32 data) {
    switch (cmd) {
...
void Samsung_GTi9100_OMXCodec::onStateChange(OMX_STATETYPE newState) {
    ...
    switch (newState) {
        ...
        case OMX_StateExecuting:
        {
            ...
            // call to Samsung_GTi9100_OMXCodec::read as mInitialBufferSubmit is true at
...
// static
size_t Samsung_GTi9100_OMXCodec::countBuffersWeOwn(const Vector<BufferInfo> &buffers) {
    size_t n = 0;
...
status_t Samsung_GTi9100_OMXCodec::freeBuffer(OMX_U32 portIndex, BufferInfo *info) {
...
status_t Samsung_GTi9100_OMXCodec::freeBuffersOnPort(
...
void Samsung_GTi9100_OMXCodec::onPortSettingsChanged(OMX_U32 portIndex) {
...
bool Samsung_GTi9100_OMXCodec::flushPortAsync(OMX_U32 portIndex) {
    CHECK(mState == EXECUTING || mState == RECONFIGURING
...
void Samsung_GTi9100_OMXCodec::disablePortAsync(OMX_U32 portIndex) {
    CHECK(mState == EXECUTING || mState == RECONFIGURING);
    CHECK_EQ(mPortStatus[portIndex], ENABLED);
...
void Samsung_GTi9100_OMXCodec::enablePortAsync(OMX_U32 portIndex) {
    CHECK(mState == EXECUTING || mState == RECONFIGURING);
...
void Samsung_GTi9100_OMXCodec::fillOutputBuffers() {
    CHECK_EQ(mState, EXECUTING);
...
void Samsung_GTi9100_OMXCodec::drainInputBuffers() {
    CHECK(mState == EXECUTING || mState == RECONFIGURING);
...
void Samsung_GTi9100_OMXCodec::drainInputBuffer(BufferInfo *info) {
    CHECK_EQ(info->mOwnedByComponent, false);
...
void Samsung_GTi9100_OMXCodec::fillOutputBuffer(BufferInfo *info) {
    CHECK_EQ(info->mOwnedByComponent, false);
...
void Samsung_GTi9100_OMXCodec::drainInputBuffer(ISamsung_GTi9100_OMX::buffer_id buffer) {
    Vector<BufferInfo> *buffers = &mPortBuffers[kPortIndexInput];
    for (size_t i = 0; i < buffers->size(); ++i) {
...
void Samsung_GTi9100_OMXCodec::fillOutputBuffer(ISamsung_GTi9100_OMX::buffer_id buffer) {
    Vector<BufferInfo> *buffers = &mPortBuffers[kPortIndexOutput];
    for (size_t i = 0; i < buffers->size(); ++i) {
        if ((*buffers)[i].mBuffer == buffer) {
#if defined(TARGET_OMAP4) && defined(OMAP_ENHANCEMENT)
...
void Samsung_GTi9100_OMXCodec::setState(State newState) {
    mState = newState;
...
void Samsung_GTi9100_OMXCodec::setRawAudioFormat(
...
void Samsung_GTi9100_OMXCodec::setAMRFormat(bool isWAMR, int32_t bitRate) {
...
void Samsung_GTi9100_OMXCodec::setAACFormat(int32_t numChannels, int32_t sampleRate, int32_t bitRate) {
    if (mIsEncoder) {
        //////////////// input port ////////////////////
        setRawAudioFormat(kPortIndexInput, sampleRate, numChannels);
...
void Samsung_GTi9100_OMXCodec::setImageOutputFormat(
...
void Samsung_GTi9100_OMXCodec::setJPEGInputFormat(
...
void Samsung_GTi9100_OMXCodec::addCodecSpecificData(const void *data, size_t size) {
...
void Samsung_GTi9100_OMXCodec::clearCodecSpecificData() {
...
status_t Samsung_GTi9100_OMXCodec::start(MetaData *meta) {
...
status_t Samsung_GTi9100_OMXCodec::stop() {
...
sp<MetaData> Samsung_GTi9100_OMXCodec::getFormat() {
    Mutex::Autolock autoLock(mLock);
...
#ifdef OMAP_ENHANCEMENT
void Samsung_GTi9100_OMXCodec::setBuffers(Vector< sp<IMemory> > mBufferAddresses, bool portReconfig){
...
status_t Samsung_GTi9100_OMXCodec::read(
...
void Samsung_GTi9100_OMXCodec::signalBufferReturned(MediaBuffer *buffer) {
    Mutex::Autolock autoLock(mLock);
...
void Samsung_GTi9100_OMXCodec::dumpPortStatus(OMX_U32 portIndex) {
    OMX_PARAM_PORTDEFINITIONTYPE def;
    InitOMXParams(&def);
    def.nPortIndex = portIndex;
...
void Samsung_GTi9100_OMXCodec::initOutputFormat(const sp<MetaData> &inputFormat) {
...
status_t Samsung_GTi9100_OMXCodec::pause() {
    Mutex::Autolock autoLock(mLock);
...
#ifdef OMAP_ENHANCEMENT
int Samsung_GTi9100_OMXCodec::getNumofOutputBuffers() {
    OMX_PARAM_PORTDEFINITIONTYPE def;
    InitOMXParams(&def);
    def.nPortIndex = kPortIndexOutput;
...
status_t QueryCodecs(
        ...
        Vector<Samsung_GTi9100_CodecCapabilities> *results) {
    results->clear();
    ...
    for (int index = 0;; ++index) {
        ...
        if (strncmp(componentName, "OMX.", 4)) {
            ...
            results->push();
            Samsung_GTi9100_CodecCapabilities *caps = &results->editItemAt(results->size() - 1);
        ...
        sp<OMXCodecObserver> observer = new OMXCodecObserver;
        ISamsung_GTi9100_OMX::node_id node;
        status_t err = omx->allocateNode(componentName, observer, &node);
        ...
        Samsung_GTi9100_OMXCodec::setComponentRole(omx, node, !queryDecoders, mime);
