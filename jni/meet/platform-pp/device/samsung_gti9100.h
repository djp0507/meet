...
#ifndef PP_SAMSUNG_GTI9100_H_

#define PP_SAMSUNG_GTI9100_H_
...
class OMXClient;
class Samsung_GTi9100_IOMXRenderer;
class Samsung_GTi9100 : public IDevice
{
public:
	Samsung_GTi9100();
	~Samsung_GTi9100();
...
private:
	...
	OMXClient* mClient;
	Samsung_GTi9100_IOMXRenderer* mRender;
	sp<MediaSource> mVideoCodec;
	sp<MediaSource> mAudioCodec;
};

}

#endif  // PP_SAMSUNG_GTI9100_H_