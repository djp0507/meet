...
//#define LOG_NDEBUG 0
#define LOG_TAG "samsung_gti9020"
...
class Samsung_GTi9020_IOMXRenderer : public IPPOMXRenderer
{
public:
	Samsung_GTi9020_IOMXRenderer(sp<IOMXRenderer>& target) 
		: mTarget(target)
	{
	}
	...
	virtual ~Samsung_GTi9020_IOMXRenderer()
	{
...
void Samsung_GTi9020::FlushCommands()
{
    LOGI("FlushCommands");
	IPCThreadState::self()->flushCommands();
}

Samsung_GTi9020::Samsung_GTi9020()
{
...
IPPOMXRenderer* Samsung_GTi9020::CreateOMXRenderer(
            //const sp<IOMX> &omx,
...
{	
	...
	return new Samsung_GTi9020_IOMXRenderer(target);
}
	
sp<MediaSource> Samsung_GTi9020::CreateOMXCodec(
            //const sp<IOMX> &omx,
...
IPPAudioTrack* Samsung_GTi9020::createAudioTrack(
			int streamType,
	        uint32_t sampleRate,
	        int format,
	        int channels,
...
status_t Samsung_GTi9020::getOutputSamplingRate(int* samplingRate, int stream)
{
...
status_t Samsung_GTi9020::getOutputFrameCount(int* frameCount, int stream)
{
    //return AudioSystem_cm::getOutputFrameCount(frameCount, stream);
    return AudioSystem::getOutputFrameCount(frameCount, stream);
}
	
bool Samsung_GTi9020::canAudioHWDecode()
{
    return true;
}
	
bool Samsung_GTi9020::canAudioHWSBR()
{
    return true;
}
