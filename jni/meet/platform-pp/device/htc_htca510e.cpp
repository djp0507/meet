...
class HTC_HTCA510e_IOMXRenderer : public IPPOMXRenderer
{
public:
	HTC_HTCA510e_IOMXRenderer(sp<IOMXRenderer>& target) 
		: mTarget(target)
	{
	}
	...
	virtual ~HTC_HTCA510e_IOMXRenderer()
	{
        //IPCThreadState::self()->flushCommands();
        LOGD("Destorying HTC_HTCA510e_IOMXRenderer");
	}
...
void HTC_HTCA510e::FlushCommands()
{
	IPCThreadState::self()->flushCommands();
}

HTC_HTCA510e::HTC_HTCA510e()
{
...
IPPOMXRenderer* HTC_HTCA510e::CreateOMXRenderer(
            //const sp<IOMX> &omx,
...
{	
    ...
    sp<IOMXRenderer> target = (mClient->interface())->createRenderer(
		                        ...
		                        componentName,
		                        //colorFormat,
		                        (OMX_COLOR_FORMATTYPE)0x7FA30C00,
		                        encodedWidth, 
		                        encodedHeight,
		                        displayWidth, 
		                        displayHeight,
	...
	return new HTC_HTCA510e_IOMXRenderer(target);
}

sp<MediaSource> HTC_HTCA510e::CreateOMXCodec(
        //const sp<IOMX> &omx,
...
status_t HTC_HTCA510e::getOutputSamplingRate(int* samplingRate, int streamType)
{
	return AudioSystem::getOutputSamplingRate(samplingRate, streamType);
}

status_t HTC_HTCA510e::getOutputFrameCount(int* frameCount, int streamType)
{
	return AudioSystem::getOutputFrameCount(frameCount, streamType);
}

bool HTC_HTCA510e::canAudioHWDecode()
{
    return false;
}

bool HTC_HTCA510e::canAudioHWSBR()
{
    return false;
}
IPPAudioTrack* HTC_HTCA510e::createAudioTrack(
        int streamType,
        uint32_t sampleRate,
        int format,
        int channels,
