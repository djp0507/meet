...
#define LOG_TAG "samsung_gti9100_IAudioPolicyService"
...
public:
    ...
    virtual status_t setDeviceConnectionState(
                                    Samsung_GTi9100_AudioSystem::audio_devices device,
    ...
    virtual Samsung_GTi9100_AudioSystem::device_connection_state getDeviceConnectionState(
                                    Samsung_GTi9100_AudioSystem::audio_devices device,
                                    const char *device_address)
    {
        Parcel data, reply;
        ...
        return static_cast <Samsung_GTi9100_AudioSystem::device_connection_state>(reply.readInt32());
    }
    ...
    virtual status_t setForceUse(Samsung_GTi9100_AudioSystem::force_use usage, Samsung_GTi9100_AudioSystem::forced_config config)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
    ...
    virtual Samsung_GTi9100_AudioSystem::forced_config getForceUse(Samsung_GTi9100_AudioSystem::force_use usage)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
        data.writeInt32(static_cast <uint32_t>(usage));
        remote()->transact(GET_FORCE_USE, data, &reply);
        return static_cast <Samsung_GTi9100_AudioSystem::forced_config> (reply.readInt32());
    }
    ...
    virtual audio_io_handle_t getOutput(
                                        ...
                                        uint32_t format,
                                        uint32_t channels,
                                        Samsung_GTi9100_AudioSystem::output_flags flags)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
    ...
    virtual audio_io_handle_t getInput(
                                    ...
                                    uint32_t format,
                                    uint32_t channels,
                                    Samsung_GTi9100_AudioSystem::audio_in_acoustics acoustics)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
    ...
    virtual status_t setStreamVolumeIndex(Samsung_GTi9100_AudioSystem::stream_type stream, int index)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
        data.writeInt32(static_cast <uint32_t>(stream));
    ...
    virtual status_t getStreamVolumeIndex(Samsung_GTi9100_AudioSystem::stream_type stream, int *index)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
        data.writeInt32(static_cast <uint32_t>(stream));
    ...
    virtual uint32_t getStrategyForStream(Samsung_GTi9100_AudioSystem::stream_type stream)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
        data.writeInt32(static_cast <uint32_t>(stream));
    ...
    uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
    switch(code) {
        case SET_DEVICE_CONNECTION_STATE: {
            ...
            Samsung_GTi9100_AudioSystem::audio_devices device =
                    static_cast <Samsung_GTi9100_AudioSystem::audio_devices>(data.readInt32());
            Samsung_GTi9100_AudioSystem::device_connection_state state =
                    static_cast <Samsung_GTi9100_AudioSystem::device_connection_state>(data.readInt32());
        ...
        case SET_FORCE_USE: {
            CHECK_INTERFACE(IAudioPolicyService, data, reply);
            Samsung_GTi9100_AudioSystem::force_use usage = static_cast <Samsung_GTi9100_AudioSystem::force_use>(data.readInt32());
            Samsung_GTi9100_AudioSystem::forced_config config =
                    static_cast <Samsung_GTi9100_AudioSystem::forced_config>(data.readInt32());
        ...
        case GET_OUTPUT: {
            CHECK_INTERFACE(IAudioPolicyService, data, reply);
            Samsung_GTi9100_AudioSystem::stream_type stream =
                    static_cast <Samsung_GTi9100_AudioSystem::stream_type>(data.readInt32());
            uint32_t samplingRate = data.readInt32();
            uint32_t format = data.readInt32();
            uint32_t channels = data.readInt32();
            Samsung_GTi9100_AudioSystem::output_flags flags =
                    static_cast <Samsung_GTi9100_AudioSystem::output_flags>(data.readInt32());
        ...
        case GET_INPUT: {
            ...
            uint32_t channels = data.readInt32();
            Samsung_GTi9100_AudioSystem::audio_in_acoustics acoustics =
                    static_cast <Samsung_GTi9100_AudioSystem::audio_in_acoustics>(data.readInt32());
