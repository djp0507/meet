...
#ifndef ANDROID_SAMSUNG_GTI9100_AUDIO_TRACK_SHARED_H
#define ANDROID_SAMSUNG_GTI9100_AUDIO_TRACK_SHARED_H
...
struct Samsung_GTi9100_audio_track_cblk_t
{
    ...
    volatile    union {
                ...
                uint32_t    sampleRate;
                // NOTE: Samsung_GTi9100_audio_track_cblk_t::frameSize is not equal to AudioTrack::frameSize() for
                ...
                // Cache line boundary (32 bytes)
                            Samsung_GTi9100_audio_track_cblk_t();
...
#endif // ANDROID_SAMSUNG_GTI9100_AUDIO_TRACK_SHARED_H