...
//#define LOG_NDEBUG 0
#define LOG_TAG "Samsung_GTi9220"
...
class Samsung_GTi9220_IOMXRenderer : public IPPOMXRenderer
{
public:
	Samsung_GTi9220_IOMXRenderer(sp<IOMXRenderer>& target) 
		: mTarget(target)
	{
	}
	...
	virtual ~Samsung_GTi9220_IOMXRenderer()
	{
...
void Samsung_GTi9220::FlushCommands()
{
	IPCThreadState::self()->flushCommands();
}

Samsung_GTi9220::Samsung_GTi9220()
{
...
IPPOMXRenderer* Samsung_GTi9220::CreateOMXRenderer(
            //const sp<IOMX> &omx,
...
{	
	...
	return new Samsung_GTi9220_IOMXRenderer(target);
}
	
sp<MediaSource> Samsung_GTi9220::CreateOMXCodec(
            //const sp<IOMX> &omx,
...
IPPAudioTrack* Samsung_GTi9220::createAudioTrack(
			int streamType,
	        uint32_t sampleRate,
	        int format,
	        int channels,
...
status_t Samsung_GTi9220::getOutputSamplingRate(int* samplingRate, int stream)
{
    return AudioSystem::getOutputSamplingRate(samplingRate, stream);
}
	
status_t Samsung_GTi9220::getOutputFrameCount(int* frameCount, int stream)
{
    return AudioSystem::getOutputFrameCount(frameCount, stream);
}
	
bool Samsung_GTi9220::canAudioHWDecode()
{
    return true;
}
	
bool Samsung_GTi9220::canAudioHWSBR()
{
    return true;
}
