...
#ifndef ANDROID_SAMSUNG_GTI9100_IAUDIOFLINGER_H
#define ANDROID_SAMSUNG_GTI9100_IAUDIOFLINGER_H
#define ANDROID_IAUDIOFLINGER_H

#include <stdint.h>
#include <sys/types.h>
#include <unistd.h>
#include "include-pp/IAudioFlingerClient.h"
...
#include "include-pp/media/IAudioRecord.h"
#include "include-pp/media/EffectApi.h"
#include "include-pp/media/IEffect.h"
#include "include-pp/media/IEffectClient.h"
...
public:
     ...
     */
//    virtual     uint32_t    test1() const = 0;
//    virtual     uint32_t    test2() const = 0;
//    virtual     uint32_t    test3() const = 0;
...
#endif // ANDROID_SAMSUNG_GTI9100_IAUDIOFLINGER_H
