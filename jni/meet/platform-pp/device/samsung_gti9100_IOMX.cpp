//#define LOG_NDEBUG 0
#define LOG_TAG "samsung_gti9100_IOMX"
...
public:
	...
	data.writeInt32(isS3D);
		...
		LOGE("5");
		sp<IBinder> pBinder = reply.readStrongBinder();
		LOGE("6 pBinder:%p", pBinder.get());
        return interface_cast<IOMXRenderer>(pBinder);
    }
#endif
...
public:
    ...
    virtual void requestRendererClone(bool enable) {LOGE("requestRendererClone");}
#endif
