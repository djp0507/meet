...
#ifndef ANDROID_SAMSUNG_GTI9300_AUDIOTRACK_H
#define ANDROID_SAMSUNG_GTI9300_AUDIOTRACK_H

#include <stdint.h>
#include <sys/types.h>

#include "include-pp/a14/frameworks/base/include/media/IAudioFlinger.h"
...
private:
    ...
    uint8_t                  mPaddingBlk[256];  // Workaround: fill with 256 bytes to avoid free memory crash;
};
