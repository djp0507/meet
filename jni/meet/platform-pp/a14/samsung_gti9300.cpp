...
//#define LOG_NDEBUG 0
#define LOG_TAG "samsung_gti9300"
...
#include "samsung_gti9300_AudioTrack.h"
#include "samsung_gti9300.h"

namespace android {

class Samsung_GTi9300_PPAudioTrack : public IPPAudioTrack {
private:
	AudioTrack* mTrack;
...
class Samsung_GTi9300_IOMXRenderer : public IPPOMXRenderer
{
public:
	Samsung_GTi9300_IOMXRenderer(const sp<Surface> &surface,
	...
	virtual ~Samsung_GTi9300_IOMXRenderer()
	{
...
void Samsung_GTi9300::FlushCommands()
{
    LOGI("FlushCommands");
	IPCThreadState::self()->flushCommands();
}

Samsung_GTi9300::Samsung_GTi9300()
{
...
IPPOMXRenderer* Samsung_GTi9300::CreateOMXRenderer(
            const sp<Surface> &surface,
            int32_t rotationDegrees)
{	

	return new Samsung_GTi9300_IOMXRenderer(surface, rotationDegrees);
}

/*
sp<IOMXRenderer> Samsung_GTi9300::CreateOMXRenderer(
            //const sp<IOMX> &omx,
...
sp<MediaSource> Samsung_GTi9300::CreateOMXCodec(
            //const sp<IOMX> &omx,
...
IPPAudioTrack* Samsung_GTi9300::createAudioTrack(
									int streamType,
							        uint32_t sampleRate,
							        int format,
							        int channels,
							        ...
							        int sessionId)
{
    return new Samsung_GTi9300_PPAudioTrack(
		    						streamType,
									sampleRate,
							        format,
							        channels,
...
status_t Samsung_GTi9300::getOutputSamplingRate(int* samplingRate, int stream)
{
...
status_t Samsung_GTi9300::getOutputFrameCount(int* frameCount, int stream)
{
    //return AudioSystem_cm::getOutputFrameCount(frameCount, stream);
    return AudioSystem::getOutputFrameCount(frameCount, stream);
}
	
bool Samsung_GTi9300::canAudioHWDecode()
{
    return true;
}
	
bool Samsung_GTi9300::canAudioHWSBR()
{
    return true;
}
