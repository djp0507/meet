...
#include "include-pp/MPEG4Extractor.h"
#include "include-pp/SampleTable.h"
...
MPEG4DataSource::MPEG4DataSource(const sp<DataSource> &source)
    : mSource(source),
      ...
      mCachedSize(0),
      mCache(NULL) {
	LOGD("Constructing MPEG4DataSource");
}

MPEG4DataSource::~MPEG4DataSource() {
    clearCache();
	LOGD("Destroying MPEG4DataSource");
}
...
MPEG4Extractor::MPEG4Extractor(const sp<DataSource> &source)
	...
	LOGD("Constructing MPEG4Extractor");
}
...
MPEG4Extractor::~MPEG4Extractor() {
	...
	LOGD("Destroying MPEG4Extractor");
}
