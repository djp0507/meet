...
#include "include-pp/a14/frameworks/base/include/media/stagefright/FileSource.h"
...
//        source = new NuCachedSource2(httpSource);
        ...
        LOGD("new FileSource: %s", uri);
        // Assume it's a filename.
        source = new FileSource(uri);
    }

    if (source == NULL || source->initCheck() != OK) {
        LOGD("source initCheck failed");
        return NULL;
    }
