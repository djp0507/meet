...
#include "libppplayer/a14/PPPlayer.h"
...
#include "include-pp/a14/frameworks/base/include/utils/SystemClock.h"
#include "include-pp/a14/system/core/include/cutils/atomic.h"
        ...
        AudioCallback cb, void *cookie)
{
	...
	*/
	...
	LOGE("mTrack create sucess!!!");
    
	LOGE("mTrack->initCheck()");
	...
	LOGE("mTrack->initCheck() success");

    LOGE("mTrack->setVolume()");
    mTrack->setVolume(mLeftVolume, mRightVolume);
	LOGE("mTrack->setVolume() success");
    
    mMsecsPerFrame = 1.e3 / (float) sampleRate;
    mLatency = mTrack->latency();

    LOGE("mLatency: %d", mLatency);
...
void AudioOutput::close()
{
    ...
    {	
    	// leoxie
    	// TODO: temporarily make this for fix a bug which crash process when delete mTrack.
		delete mTrack;
		mTrack = NULL;
    }
}
...
status_t PPPlayer::startP2PEngine() {
	...
	LOGE("=========> Calling PPBOX_StartP2PEngine start");
	...
	LOGE("=========> Calling PPBOX_StartP2PEngine end");
