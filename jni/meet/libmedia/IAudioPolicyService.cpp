...
public:
    ...
    virtual status_t setDeviceConnectionState(
                                    AudioSystem_cm::audio_devices device,
    ...
    virtual AudioSystem_cm::device_connection_state getDeviceConnectionState(
                                    AudioSystem_cm::audio_devices device,
                                    const char *device_address)
    {
        Parcel data, reply;
        ...
        return static_cast <AudioSystem_cm::device_connection_state>(reply.readInt32());
    }
    ...
    virtual status_t setForceUse(AudioSystem_cm::force_use usage, AudioSystem_cm::forced_config config)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
    ...
    virtual AudioSystem_cm::forced_config getForceUse(AudioSystem_cm::force_use usage)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
        data.writeInt32(static_cast <uint32_t>(usage));
        remote()->transact(GET_FORCE_USE, data, &reply);
        return static_cast <AudioSystem_cm::forced_config> (reply.readInt32());
    }
    ...
    virtual audio_io_handle_t getOutput(
                                        ...
                                        uint32_t format,
                                        uint32_t channels,
                                        AudioSystem_cm::output_flags flags)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
    ...
    virtual audio_io_handle_t getInput(
                                    ...
                                    uint32_t format,
                                    uint32_t channels,
                                    AudioSystem_cm::audio_in_acoustics acoustics)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
    ...
    virtual status_t setStreamVolumeIndex(AudioSystem_cm::stream_type stream, int index)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
        data.writeInt32(static_cast <uint32_t>(stream));
    ...
    virtual status_t getStreamVolumeIndex(AudioSystem_cm::stream_type stream, int *index)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
        data.writeInt32(static_cast <uint32_t>(stream));
    ...
    virtual uint32_t getStrategyForStream(AudioSystem_cm::stream_type stream)
    {
        Parcel data, reply;
        data.writeInterfaceToken(IAudioPolicyService::getInterfaceDescriptor());
        data.writeInt32(static_cast <uint32_t>(stream));
    ...
    uint32_t code, const Parcel& data, Parcel* reply, uint32_t flags)
{
    switch(code) {
        case SET_DEVICE_CONNECTION_STATE: {
            ...
            AudioSystem_cm::audio_devices device =
                    static_cast <AudioSystem_cm::audio_devices>(data.readInt32());
            AudioSystem_cm::device_connection_state state =
                    static_cast <AudioSystem_cm::device_connection_state>(data.readInt32());
        ...
        case SET_FORCE_USE: {
            CHECK_INTERFACE(IAudioPolicyService, data, reply);
            AudioSystem_cm::force_use usage = static_cast <AudioSystem_cm::force_use>(data.readInt32());
            AudioSystem_cm::forced_config config =
                    static_cast <AudioSystem_cm::forced_config>(data.readInt32());
        ...
        case GET_OUTPUT: {
            CHECK_INTERFACE(IAudioPolicyService, data, reply);
            AudioSystem_cm::stream_type stream =
                    static_cast <AudioSystem_cm::stream_type>(data.readInt32());
            uint32_t samplingRate = data.readInt32();
            uint32_t format = data.readInt32();
            uint32_t channels = data.readInt32();
            AudioSystem_cm::output_flags flags =
                    static_cast <AudioSystem_cm::output_flags>(data.readInt32());
        ...
        case GET_INPUT: {
            ...
            uint32_t channels = data.readInt32();
            AudioSystem_cm::audio_in_acoustics acoustics =
                    static_cast <AudioSystem_cm::audio_in_acoustics>(data.readInt32());
