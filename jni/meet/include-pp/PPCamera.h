...
#include "include-pp/CameraHardwareInterface.h"
...
*/
    class PPCamera  : public RefBase // : public BnCamera
    {
    public:
...
//    private:
	...
	sp<ISurface> getISurface(sp<Surface> surface) const
	{
        ...
        static sp<PPCamera>       getClientFromCookie(void* user);
