...
#include "include-pp/IMediaPlayer.h"
#include "include-pp/IMediaPlayerService.h"
#include "include-pp/MediaPlayerInterface.h"
#include "platform-pp/PPPlatForm.h"
#include "libmedia-pp/Metadata.h"
...
class MediaPlayerService : public IMediaPlayerService
{
    ...
    public:
        ...
        virtual ssize_t         frameSize() const { return ssize_t(mChannelCount * ((mFormat == AudioSystemWrapper::PCM_16_BIT)?sizeof(int16_t):sizeof(u_int8_t))); }
        virtual uint32_t        latency() const;
        virtual float           msecsPerFrame() const;
        virtual status_t        getPosition(uint32_t *position);
        ...
        virtual void            close() {}
                ...
                sp<IMemoryHeap> getHeap() const { return NULL/*mHeap*/; }
